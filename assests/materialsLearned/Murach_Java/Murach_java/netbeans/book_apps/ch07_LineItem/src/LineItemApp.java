public class LineItemApp {
    ...
    public static void main(String args[]) {
        ...
        while (choice.equalsIgnoreCase("y")) {
            ...
            System.out.println("Code:        " + lineItem.getProduct().getCode());
            System.out.println("Description: " + lineItem.getProduct().getDescription());
            System.out.println("Price:       " + lineItem.getProduct().getPriceFormatted());
